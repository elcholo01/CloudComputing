# Brza skripta za rešavanje problema

Write-Host "Brzo rešavam probleme..."
...
# 3. Rešimo WorkerRole probleme
$workerFiles = @("HealthMonitoringService\WorkerRole.cs", "NotificationService\WorkerRole.cs")
...
# 4. Rešimo WebRole probleme
$webFiles = @("MovieDiscussionService\WebRole.cs", "HealthStatusService\WebRole.cs")
